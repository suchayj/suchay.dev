  ...
  return (
    <main className="about-page" id="main-content">
      ...
      <section className="about-closing about-shell" id="about-contact">
        ...
        <div className="closing-actions"><a className="closing-email" href="mailto:suchayj@gmail.com">suchayj@gmail.com <Arrow /></a><SiteNavLink className="btn btn-primary" href="/work">View selected work <span aria-hidden="true">→</span></SiteNavLink></div>
      ...
      <footer className="about-footer"><span>© {new Date().getFullYear()} Suchay Janbandhu</span><SiteNavLink href="/">suchay.dev</SiteNavLink><div><a href="https://github.com/suchayj">GitHub</a><a href="https://www.linkedin.com/in/suchay-janbandhu-9a014779/">LinkedIn</a></div></footer>
    </main>
  );
}
